  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="w-9 h-9 bg-brand-600 rounded-xl flex items-center justify-center mr-3 shadow-card">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-testid="portal-dashboard">
        {/* Welcome Section */}
        <div className="bg-gradient-to-r from-brand-600 to-accent-600 rounded-2xl text-white p-8 shadow-card mb-8">
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <button className="flex items-center p-4 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-colors">
            ...
            <button className="flex items-center p-4 border border-gray-200 rounded-xl hover:border-green-300 hover:bg-green-50 transition-colors">
            ...
            <button 
              ...
              className="flex items-center p-4 border border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-colors"
            >
            ...
            <button className="flex items-center p-4 border border-gray-200 rounded-xl hover:border-orange-300 hover:bg-orange-50 transition-colors">
        ...
        {/* Development Notice */}
        <div className="mt-8 bg-brand-50 border border-brand-200 rounded-2xl p-4">
          <div className="flex items-center">
