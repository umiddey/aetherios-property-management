...
import { PROFESSIONAL_FORM_CLASSES, PROFESSIONAL_MODAL_CLASSES, getProfessionalInputClasses, getProfessionalSelectClasses } from './ui/ProfessionalFormStandards';
          ...
          {!showAddForm && (
            <div className="mb-6">
              <button
                ...
                disabled={loading}
                className="px-6 py-3 bg-blue-600 text-white rounded-md font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center space-x-2"
              >
              ...
              <form onSubmit={editingLicense ? handleUpdateLicense : handleAddLicense} className="space-y-4">
                ...
                <div className="flex space-x-4">
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-3 bg-blue-600 text-white rounded-md font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50"
                  >
                  ...
                  <button
                    type="button"
                    onClick={cancelEdit}
                    className="px-6 py-3 bg-gray-500 text-white rounded-md font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                  >
                    Cancel
                  </button>
                </div>
          ...
          {loading && !showAddForm ? (
            ...
            <div className="space-y-4">
              {licenses.map((license) => (
                <div key={license.license_id} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
